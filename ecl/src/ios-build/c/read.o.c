...
#line 486
		#line 486
		cl_object __value0 = cl_macroexpand_1(2, cl_list(2, ECL_SYM("SI::QUASIQUOTE",1472), in), ECL_NIL);
#line 486
		the_env->nvalues = 1;
#line 486
		return __value0;
...
#line 488
		#line 488
		cl_object __value0 = cl_list(2,ECL_SYM("SI::QUASIQUOTE",1472),in);
#line 488
		the_env->nvalues = 1;
#line 488
		return __value0;
...
#line 1595
	strm = stream_or_default_input(strm);
		...
		value0 = _ecl_funcall2(ECL_SYM("GRAY::STREAM-READ-LINE",1639), strm);
...
#line 1708
	...
	if (!ECL_ANSI_STREAM_P(strm)) {
		cl_object output =
			_ecl_funcall2(ECL_SYM("GRAY::STREAM-READ-CHAR-NO-HANG",1638), strm);
...
#line 1757
	...
	if (!ECL_ANSI_STREAM_P(stream))
		return funcall(5, ECL_SYM("GRAY::STREAM-READ-SEQUENCE",1640), stream, sequence, start, end);
	else
#endif
...
#line 2014
	...
	va_start(ARGS, r);
#line 2014
	if (ecl_unlikely(narg < 1|| narg > 2)) FEwrong_num_arguments(ecl_make_fixnum(1721));
#line 2014
	if (narg > 1) {
#line 2014
...
#line 2014
	assert_type_readtable(ecl_make_fixnum(/*EXT::READTABLE-LOCK*/1721), 1, r);
...
init_read(void)
{
	...
	ECL_SET(ECL_SYM("*READ-DEFAULT-FLOAT-FORMAT*",62), ECL_SYM("SINGLE-FLOAT",778));

        {
                ...
                ECL_SET(ECL_SYM("SI::+ECL-SYNTAX-PROGV-LIST+",1723), CONS(var,val));
                var = cl_list(23,
                              ECL_SYM("*PRINT-PPRINT-DISPATCH*",54), /* See end of pprint.lsp */
                              ECL_SYM("*PRINT-ARRAY*",44),
                              ECL_SYM("*PRINT-BASE*",45),
                ...
                val = cl_list(23,
                              ...
                              /*si::*sharp-eq-context**/ ECL_NIL,
			      /*si::*cicle-counter**/ ECL_NIL);
                ECL_SET(ECL_SYM("SI::+IO-SYNTAX-PROGV-LIST+",1722), CONS(var,val));
        }
}
...
# endif
                progv_list = ECL_SYM_VAL(env, ECL_SYM("SI::+ECL-SYNTAX-PROGV-LIST+",1723));
