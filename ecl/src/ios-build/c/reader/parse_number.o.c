...
infinity(cl_index exp_char, int sign)
{
        ...
        case 'f':  case 'F':
                var = (sign<0)?
                        ECL_SYM("EXT::SINGLE-FLOAT-NEGATIVE-INFINITY",1713) :
                        ECL_SYM("EXT::SINGLE-FLOAT-POSITIVE-INFINITY",1709);
                        break;
        case 'l':  case 'L':
#ifdef ECL_LONG_FLOAT
                var = (sign<0)?
                        ECL_SYM("EXT::LONG-FLOAT-NEGATIVE-INFINITY",1715) :
                        ECL_SYM("EXT::LONG-FLOAT-POSITIVE-INFINITY",1711);
                        break;
#endif
        case 'd':  case 'D':
                var = (sign<0)?
                        ECL_SYM("EXT::DOUBLE-FLOAT-NEGATIVE-INFINITY",1714) :
                        ECL_SYM("EXT::DOUBLE-FLOAT-POSITIVE-INFINITY",1710);
                        break;
        default:
                return OBJNULL;
        }
