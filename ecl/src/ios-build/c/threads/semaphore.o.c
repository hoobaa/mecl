...
{
        FEwrong_type_argument(ECL_SYM("MP::SEMAPHORE",1444), semaphore);
}
...
#line 43
	static cl_object KEYS[2] = {(cl_object)(cl_symbols+1273), (cl_object)(cl_symbols+1451)};
	cl_object name;
	cl_object count;
#line 43
...
#line 80
	if (ecl_unlikely(narg < 1|| narg > 2)) FEwrong_num_arguments(ecl_make_fixnum(1446));
#line 80
	if (narg > 1) {
#line 80
