...
{
        FEwrong_type_argument(ECL_SYM("MP::BARRIER",1452), barrier);
}
...
#line 87
	const cl_env_ptr the_env = ecl_process_env();
#line 87
	static cl_object KEYS[3] = {(cl_object)(cl_symbols+1460), (cl_object)(cl_symbols+1459), (cl_object)(cl_symbols+1461)};
...
#line 141
	...
	ecl_va_start(ARGS, barrier, narg, 1);
#line 141
	if (ecl_unlikely(narg < 1)) FEwrong_num_arguments(ecl_make_fixnum(1455));
#line 141
