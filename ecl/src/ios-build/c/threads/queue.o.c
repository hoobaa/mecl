#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/threads/queue.d"
...
ecl_wait_on_timed(cl_env_ptr env, cl_object (*condition)(cl_env_ptr, cl_object), cl_object o)
{
	...
	ecl_bds_bind(the_env, ECL_SYM("EXT::*INTERRUPTS-ENABLED*",1023), ECL_NIL);
	ECL_UNWIND_PROTECT_BEGIN(the_env) {
		...
		ecl_bds_bind(the_env, ECL_SYM("EXT::*INTERRUPTS-ENABLED*",1023), ECL_T);
