#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/cfun.d"
...
{
	si_fset(2, sym,
		ecl_make_cfun(c_function, sym, ecl_symbol_value(ECL_SYM("SI::*CBLOCK*",1013)), narg));
}
...
cl_function_lambda_expression(cl_object fun)
{
	...
	case t_bytecodes:
		...
		else if (name != ECL_SYM("SI::BYTECODES",1661))
