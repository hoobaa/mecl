#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/time.d"
...
cl_sleep(cl_object z)
{
	...
	if (ecl_minusp(z))
		cl_error(9, ECL_SYM("SIMPLE-TYPE-ERROR",773), ECL_SYM(":FORMAT-CONTROL",1240),
			    ...
			    ECL_SYM(":FORMAT-ARGUMENTS",1239), cl_list(1, z),
			    ECL_SYM(":EXPECTED-TYPE",1232), ECL_SYM("REAL",703), ECL_SYM(":DATUM",1214), z);
...
init_unixtime(void)
{
	...
	ECL_SET(ECL_SYM("INTERNAL-TIME-UNITS-PER-SECOND",443), ecl_make_fixnum(1000));
