...
static const cl_object ecl_aet_to_ffi_table[ecl_aet_bc+1] = {
	ECL_SYM(":VOID",1382), /* ecl_aet_object */
	ECL_SYM(":FLOAT",1369), /* ecl_aet_df */
	ECL_SYM(":DOUBLE",1367), /* ecl_aet_df */
	ECL_SYM(":VOID",1382), /* ecl_aet_bit */
#if ECL_FIXNUM_BITS == 32 && defined(ecl_uint32_t)
        ECL_SYM(":INT32-T",1373), /* ecl_aet_fix */
        ECL_SYM(":UINT32-T",1385), /* ecl_aet_index */
#else
# if ECL_FIXNUM_BITS == 64 && defined(ecl_uint64_t)
        ECL_SYM(":INT64-T",1374), /* ecl_aet_fix */
        ECL_SYM(":UINT64-T",1386), /* ecl_aet_index */
# else
        ECL_SYM(":VOID",1382), /* ecl_aet_fix */
        ECL_SYM(":VOID",1382), /* ecl_aet_index */
# endif
#endif
	ECL_SYM(":UINT8-T",1383), /* ecl_aet_b8 */
        ECL_SYM(":INT8-T",1371), /* ecl_aet_i8 */
#ifdef ecl_uint16_t
        ECL_SYM(":UINT16-T",1384), /* ecl_aet_b16 */
        ECL_SYM(":INT16-T",1372), /* ecl_aet_i16 */
#endif
#ifdef ecl_uint32_t
        ECL_SYM(":UINT32-T",1385), /* ecl_aet_b32 */
        ECL_SYM(":INT32-T",1373), /* ecl_aet_i32 */
#endif
#ifdef ecl_uint64_t
        ECL_SYM(":UINT64-T",1386), /* ecl_aet_b64 */
        ECL_SYM(":INT64-T",1374), /* ecl_aet_i64 */
#endif
#ifdef ECL_UNICODE
# ifdef ecl_int32_t
	ECL_SYM(":INT32-T",1373), /* ecl_aet_ch */
# else
        ECL_SYM(":VOID",1382), /* ecl_aet_ch */
# endif
#endif
	ECL_SYM(":CHAR",1365) /* ecl_aet_bc */
};
...
ecl_foreign_type_table[] = {
	FFI_DESC(ECL_SYM(":CHAR",1365), char),
	FFI_DESC(ECL_SYM(":UNSIGNED-CHAR",1388), unsigned char),
	FFI_DESC(ECL_SYM(":BYTE",1364), ecl_int8_t),
        FFI_DESC(ECL_SYM(":UNSIGNED-BYTE",1387), ecl_uint8_t),
	FFI_DESC(ECL_SYM(":SHORT",1379), short),
	FFI_DESC(ECL_SYM(":UNSIGNED-SHORT",1392), unsigned short),
	FFI_DESC(ECL_SYM(":INT",1370), int),
	FFI_DESC(ECL_SYM(":UNSIGNED-INT",1389), unsigned int),
	FFI_DESC(ECL_SYM(":LONG",1375), long),
	FFI_DESC(ECL_SYM(":UNSIGNED-LONG",1390), unsigned long),
#ifdef ecl_uint8_t
        FFI_DESC(ECL_SYM(":INT8-T",1371), ecl_int8_t),
        FFI_DESC(ECL_SYM(":UINT8-T",1383), ecl_uint8_t),
#endif
#ifdef ecl_uint16_t
        FFI_DESC(ECL_SYM(":INT16-T",1372), ecl_int16_t),
        FFI_DESC(ECL_SYM(":UINT16-T",1384), ecl_uint16_t),
#endif
#ifdef ecl_uint32_t
        FFI_DESC(ECL_SYM(":INT32-T",1373), ecl_int32_t),
        FFI_DESC(ECL_SYM(":UINT32-T",1385), ecl_uint32_t),
#endif
#ifdef ecl_uint64_t
        FFI_DESC(ECL_SYM(":INT64-T",1374), ecl_int64_t),
        FFI_DESC(ECL_SYM(":UINT64-T",1386), ecl_uint64_t),
#endif
#ifdef ecl_long_long_t
        FFI_DESC(ECL_SYM(":LONG-LONG",1376), long long),
        FFI_DESC(ECL_SYM(":UNSIGNED-LONG-LONG",1391), unsigned long long),
#endif
	FFI_DESC(ECL_SYM(":POINTER-VOID",1378), void *),
	FFI_DESC(ECL_SYM(":CSTRING",1366), char *),
	FFI_DESC(ECL_SYM(":OBJECT",1278), cl_object),
	FFI_DESC(ECL_SYM(":FLOAT",1369), float),
	FFI_DESC(ECL_SYM(":DOUBLE",1367), double),
	{ECL_SYM(":VOID",1382), 0, 0}
};

#ifdef ECL_DYNAMIC_FFI
static const cl_object ecl_foreign_cc_table[] = {
	ECL_SYM(":CDECL",1595),
	ECL_SYM(":STDCALL",1596)
};
#endif
...
#ifdef X86_WIN32
	{ECL_SYM(":CDECL",1595), FFI_SYSV},
	{ECL_SYM(":SYSV",1726), FFI_SYSV},
	{ECL_SYM(":STDCALL",1596), FFI_STDCALL},
#elif defined(X86_WIN64)
	{ECL_SYM(":WIN64",1728), FFI_WIN64},
#elif defined(X86_ANY) || defined(X86) || defined(X86_64)
	{ECL_SYM(":CDECL",1595), FFI_SYSV},
	{ECL_SYM(":SYSV",1726), FFI_SYSV},
	{ECL_SYM(":UNIX64",1727), FFI_UNIX64},
#endif
};

static ffi_type *ecl_type_to_libffi_type[] = {
	&ffi_type_schar, /*ECL_SYM(":CHAR",1365),*/
	&ffi_type_uchar, /*ECL_SYM(":UNSIGNED-CHAR",1388),*/
	&ffi_type_sint8, /*ECL_SYM(":BYTE",1364),*/
	&ffi_type_uint8, /*ECL_SYM(":UNSIGNED-BYTE",1387),*/
	&ffi_type_sshort, /*ECL_SYM(":SHORT",1379),*/
	&ffi_type_ushort, /*ECL_SYM(":UNSIGNED-SHORT",1392),*/
	&ffi_type_sint, /*ECL_SYM(":INT",1370),*/
	&ffi_type_uint, /*ECL_SYM(":UNSIGNED-INT",1389),*/
	&ffi_type_slong, /*ECL_SYM(":LONG",1375),*/
	&ffi_type_ulong, /*ECL_SYM(":UNSIGNED-LONG",1390),*/
#ifdef ecl_uint8_t
        &ffi_type_sint8, /*ECL_SYM(":INT8-T",1371),*/
        &ffi_type_uint8, /*ECL_SYM(":UINT8-T",1383),*/
#endif
#ifdef ecl_uint16_t
        &ffi_type_sint16, /*ECL_SYM(":INT16-T",1372),*/
        &ffi_type_uint16, /*ECL_SYM(":UINT16-T",1384),*/
#endif
#ifdef ecl_uint32_t
        &ffi_type_sint32, /*ECL_SYM(":INT32-T",1373),*/
        &ffi_type_uint32, /*ECL_SYM(":UINT32-T",1385),*/
#endif
#ifdef ecl_uint64_t
        &ffi_type_sint64, /*ECL_SYM(":INT64-T",1374),*/
        &ffi_type_uint64, /*ECL_SYM(":UINT64-T",1386),*/
#endif
#ifdef ecl_long_long_t
        &ffi_type_sint64, /*ECL_SYM(":LONG-LONG",1376),*/ /*FIXME! libffi does not have long long */
        &ffi_type_uint64, /*ECL_SYM(":UNSIGNED-LONG-LONG",1391),*/
#endif
	&ffi_type_pointer, /*ECL_SYM(":POINTER-VOID",1378),*/
	&ffi_type_pointer, /*ECL_SYM(":CSTRING",1366),*/
	&ffi_type_pointer, /*ECL_SYM(":OBJECT",1278),*/
	&ffi_type_float, /*ECL_SYM(":FLOAT",1369),*/
	&ffi_type_double, /*ECL_SYM(":DOUBLE",1367),*/
	&ffi_type_void /*ECL_SYM(":VOID",1382)*/
};
#endif /* HAVE_LIBFFI */
...
ecl_make_foreign_data(cl_object tag, cl_index size, void *data)
{
	...
	output->foreign.tag = tag == ECL_NIL ? ECL_SYM(":VOID",1382) : tag;
...
ecl_foreign_data_ref_elt(void *p, enum ecl_ffi_tag tag)
{
	...
	case ECL_FFI_POINTER_VOID:
		return ecl_make_foreign_data(ECL_SYM(":POINTER-VOID",1378), 0, *(void **)p);
...
{
	if (ecl_unlikely(ecl_t_of(f) != t_foreign))
                FEwrong_type_only_arg(ecl_make_fixnum(/*SI::NULL-POINTER-P*/1361), f,
                                      ecl_make_fixnum(/*SI::FOREIGN-DATA*/1345));
	{
#line 684
		const cl_env_ptr the_env = ecl_process_env();
...
# ifdef ECL_THREADS
	mp_get_lock(1, ecl_symbol_value(ECL_SYM("MP::+LOAD-COMPILE-LOCK+",1427)));
...
# ifdef ECL_THREADS
	...
	mp_giveup_lock(ecl_symbol_value(ECL_SYM("MP::+LOAD-COMPILE-LOCK+",1427)));
...
#line 852
	if (ecl_unlikely(narg < 4|| narg > 5)) FEwrong_num_arguments(ecl_make_fixnum(1593));
#line 852
	if (narg > 4) {
#line 852
...
#line 852
		cctype = ECL_SYM(":CDECL",1595);
#line 852
	}
#line 852
	data = cl_list(3, fun, rtype, argtypes);
	cbk  = ecl_make_foreign_data(ECL_SYM(":POINTER-VOID",1378), 0, ecl_dynamic_callback_make(data, ecl_foreign_cc_code(cctype)));

	si_put_sysprop(sym, ECL_SYM(":CALLBACK",1592), CONS(cbk, data));
	{
#line 856
		#line 856
...
#line 991
{
	 ...
	 * where the code resides. */
        ...
        cl_object closure_object = ecl_make_foreign_data(ECL_SYM(":POINTER-VOID",1378),
                                                         sizeof(ffi_closure),
                                                         closure);
        si_set_finalizer(closure_object, ECL_SYM("SI::FREE-FFI-CLOSURE",1594));

        cl_object data = cl_list(6, closure_object,
                                 fun, return_type, arg_types, cc_type,
                                 ecl_make_foreign_data(ECL_SYM(":POINTER-VOID",1378),
                                                       sizeof(*cif), cif),
                                 ecl_make_foreign_data(ECL_SYM(":POINTER-VOID",1378),
                                                       (n + 1) * sizeof(ffi_type*),
                                                       types));
	...
	si_put_sysprop(sym, ECL_SYM(":CALLBACK",1592), data);
        {
#line 1024
	#line 1024
