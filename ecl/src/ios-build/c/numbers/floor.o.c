#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/numbers/floor.d"
...
#endif
	default:
                FEwrong_type_nth_arg(ecl_make_fixnum(/*FLOOR*/384),1,x,ecl_make_fixnum(/*REAL*/703));
	}
...
MATH_DISPATCH2_BEGIN(x,y)
{
	...
	default: DISPATCH2_ERROR: {
		if (!ecl_realp(x))
			...
			FEwrong_type_nth_arg(ecl_make_fixnum(/*FLOOR*/384), 2, y, ecl_make_fixnum(/*REAL*/703));
	}
}
MATH_DISPATCH2_END;
	ecl_return2(the_env, v0, v1);
