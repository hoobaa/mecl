#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/numbers/minus.d"
...
MATH_DISPATCH2_BEGIN(x,y)
{
        ...
        CASE_UNKNOWN(ecl_make_fixnum(/*-*/17),x,y,ecl_make_fixnum(/*NUMBER*/606));
}
MATH_DISPATCH2_END;
}
...
ecl_minus(cl_object x, cl_object y)
{
	...
	case t_fixnum:
		...
		case t_complex:
			goto COMPLEX;
		default:
			FEwrong_type_nth_arg(ecl_make_fixnum(/*-*/17), 2, y, ecl_make_fixnum(/*NUMBER*/606));
		}
	case t_bignum:
		switch (ecl_t_of(y)) {
		case t_fixnum:
	...
	case t_complex:
		...
		return ecl_make_complex(z, z1);
	default:
		FEwrong_type_nth_arg(ecl_make_fixnum(/*-*/17), 1, x, ecl_make_fixnum(/*NUMBER*/606));
	}
}
