#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/numbers/number_compare.d"
...
#endif
		default:
			FEwrong_type_nth_arg(ecl_make_fixnum(/*<*/72), 2, y, ecl_make_fixnum(/*REAL*/703));
		}
	case t_bignum:
		switch (ty) {
		case t_fixnum:
...
#endif
	default:
		FEwrong_type_nth_arg(ecl_make_fixnum(/*<*/72), 1, x, ecl_make_fixnum(/*REAL*/703));
	}
}
