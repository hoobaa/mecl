...
(si::pathname-translations "BUILD" `(("**;*.*.*" "/Users/strobolights/dev/mecl/ecl/src/ios-build/**/*.*")))
...
;;;
(si::pathname-translations "TMP" '(("**;*.*.*" "/Users/strobolights/dev/mecl/ecl/src/ios-build/**/*.*")))
