...
(setf (gethash  "aarch64-apple-darwin" cross-compilers)
      (make-instance 'cross-compiler
       ...
       :cc-flags "   -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.4.sdk/ -DAPPLE -I/Users/strobolights/dev/mecl/local-install/iPhoneOS-arm64/include -D_THREAD_SAFE -Ddarwin"
       :cc-optimize #-msvc "-O2"
