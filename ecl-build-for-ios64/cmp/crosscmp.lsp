...
(setf (gethash  "aarch64-apple-darwin" cross-compilers)
      (make-instance 'cross-compiler
       :features (cons :wants-rt (cons :wants-bytecmp (cons :builtin-bytecmp (cons :wants-profile (cons :wants-defsystem (cons :wants-asdf (cons :builtin-asdf (cons :wants-serve-event (cons :wants-sockets (cons :cross *features*))))))))))
       ...
       :cc-flags "   -g -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.4.sdk/ -DAPPLE -I/Users/strobolights/dev/mecl/local-install/iPhoneOS-arm64/include -D_THREAD_SAFE -Ddarwin"
       :cc-optimize #-msvc "-O2"
