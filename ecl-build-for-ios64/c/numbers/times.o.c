#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/numbers/times.d"
...
MATH_DISPATCH2_BEGIN(x,y)
{
        ...
        CASE_UNKNOWN(ecl_make_fixnum(/***/18),x,y,ecl_make_fixnum(/*NUMBER*/606));
}
MATH_DISPATCH2_END;
}
...
ecl_times(cl_object x, cl_object y)
{
	...
	case t_fixnum:
		...
		case t_complex:
			goto COMPLEX;
		default:
			FEwrong_type_nth_arg(ecl_make_fixnum(/***/18), 2, y, ecl_make_fixnum(/*NUMBER*/606));
		}
	case t_bignum:
		switch (ecl_t_of(y)) {
		case t_fixnum:
	...
	default:
		FEwrong_type_nth_arg(ecl_make_fixnum(/***/18), 1, x, ecl_make_fixnum(/*NUMBER*/606));
	}
}
