#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/numbers/divide.d"
...
ecl_divide(cl_object x, cl_object y)
{
	...
	case t_bignum:
		...
		case t_complex:
			goto COMPLEX;
		default:
			FEwrong_type_nth_arg(ecl_make_fixnum(/*/*/21), 2, y, ecl_make_fixnum(/*NUMBER*/606));
		}
	case t_ratio:
		switch (ecl_t_of(y)) {
		case t_fixnum:
	...
	case t_complex:
		...
		return(z);
	default:
		FEwrong_type_nth_arg(ecl_make_fixnum(/*/*/21), 1, x, ecl_make_fixnum(/*NUMBER*/606));
	}
}
