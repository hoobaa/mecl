#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/number.d"
...
ecl_to_bit(cl_object x) {
        if (ecl_unlikely((x != ecl_make_fixnum(0)) && (x != ecl_make_fixnum(1))))
                FEwrong_type_nth_arg(ecl_make_fixnum(/*COERCE*/231), 1, x, ecl_make_fixnum(/*BIT*/123));
...
#endif
	default:
                FEwrong_type_nth_arg(ecl_make_fixnum(/*COERCE*/231), 1, x, ecl_make_fixnum(/*REAL*/703));
	}
}
