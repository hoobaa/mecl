#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/cons.d"
...
{
  if (ecl_unlikely(!ECL_LISTP(x))) FEwrong_type_nth_arg(ecl_make_fixnum(/*CAR*/180), 1, x, ecl_make_fixnum(/*LIST*/481));
  if (Null(x)) return x;
  x = ECL_CONS_CAR(x);
  return x;
}
