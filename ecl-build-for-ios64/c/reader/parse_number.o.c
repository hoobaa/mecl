#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/reader/parse_number.d"
...
infinity(cl_index exp_char, int sign)
{
        ...
        case 'f':  case 'F':
                var = (sign<0)?
                        ECL_SYM("EXT::SINGLE-FLOAT-NEGATIVE-INFINITY",1711) :
                        ECL_SYM("EXT::SINGLE-FLOAT-POSITIVE-INFINITY",1707);
                        break;
        case 'l':  case 'L':
#ifdef ECL_LONG_FLOAT
                var = (sign<0)?
                        ECL_SYM("EXT::LONG-FLOAT-NEGATIVE-INFINITY",1713) :
                        ECL_SYM("EXT::LONG-FLOAT-POSITIVE-INFINITY",1709);
                        break;
#endif
        case 'd':  case 'D':
                var = (sign<0)?
                        ECL_SYM("EXT::DOUBLE-FLOAT-NEGATIVE-INFINITY",1712) :
                        ECL_SYM("EXT::DOUBLE-FLOAT-POSITIVE-INFINITY",1708);
                        break;
        default:
                return OBJNULL;
        }
