#line 1 "/Users/strobolights/dev/mecl/ecl/src/c/printer/integer_to_string.d"
...
bignum_to_string(cl_object buffer, cl_object x, cl_object base)
{
        ...
        if (!ECL_FIXNUMP(base) || ((b = ecl_fixnum(base)) < 2) || (b > 36)) {
                FEwrong_type_nth_arg(ecl_make_fixnum(/*SI::INTEGER-TO-STRING*/1806), 3, base,
                                     cl_list(3, ECL_SYM("INTEGER",437), ecl_make_fixnum(2),
                                             ecl_make_fixnum(36)));
        }
...
#line 79
        ...
        default:
                FEwrong_type_nth_arg(ecl_make_fixnum(/*SI::INTEGER-TO-STRING*/1806), 2,
                                     ECL_SYM("INTEGER",437), integer);
        }
}
