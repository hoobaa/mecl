...
L32:;
         ...
         if (!(ecl_zerop(v11))) { goto L35; }
         cl_env_copy->values[0] = ECL_NIL;
         cl_env_copy->nvalues = 1;
         goto L6;
L35:;
         if (!(ecl_minusp(v11))) { goto L37; }
...
extern "C"
#endif
ECL_DLLEXPORT void _eclqZIWPfb7_7AGxWE21(cl_object flag)
{
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 cl_object *VVtemp;
 ...
 #endif
 Cblock->cblock.data_text = "@EcLtAg:_eclqZIWPfb7_7AGxWE21@";
