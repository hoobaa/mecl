...
(progn
  ...
  (setq *features* (cons :wants-rt (cons :wants-bytecmp (cons :builtin-bytecmp (cons :wants-profile (cons :wants-defsystem (cons :wants-asdf (cons :builtin-asdf (cons :wants-serve-event (cons :wants-sockets (cons :cross *features*))))))))))))
...
(progn
  ...
  (si::dump-documentation "/Users/strobolights/dev/mecl/ecl-build-for-ios64/help.doc"))
...
;;;
(setq c::*cc-flags*
      #-msvc "   -g -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.4.sdk/ -DAPPLE -I/Users/strobolights/dev/mecl/local-install/iPhoneOS-arm64/include -D_THREAD_SAFE -Ddarwin -I\"/Users/strobolights/dev/mecl/ecl/src/c\""
      #+msvc " -g -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.4.sdk/ -DAPPLE -I/Users/strobolights/dev/mecl/local-install/iPhoneOS-arm64/include -D_THREAD_SAFE -Ddarwin"
      c::*ecl-include-directory* "/Users/strobolights/dev/mecl/ecl-build-for-ios64/"
      c::*ecl-library-directory* "/Users/strobolights/dev/mecl/ecl-build-for-ios64/")
#-:wants-dlopen 
(setf c::*ld-flags*
...
(let* ((c::*cc-flags* (concatenate 'string "-DECL_API -I\"/Users/strobolights/dev/mecl/ecl-build-for-ios64/c\" " c::*cc-flags*))
...
(let* ((c::*ld-shared-flags* #-msvc "-dynamiclib -flat_namespace -undefined suppress  -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.4.sdk/ -arch arm64 -D__arm__ -L/Users/strobolights/dev/mecl/local-install/iPhoneOS-arm64/lib    -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.4.sdk/ -arch arm64 -D__arm__ -L/Users/strobolights/dev/mecl/local-install/iPhoneOS-arm64/lib    -Wl,-install_name,/Users/strobolights/dev/mecl/local-install/iPhoneOS-arm64/lib//libecl.12.12.dylib -Wl,-compatibility_version,12.12.1 -latomic_ops   -lgmp -lgc -lpthread   -lm "
       ...
       (c::*cc-flags* (concatenate 'string "-DECL_API -I/Users/strobolights/dev/mecl/ecl-build-for-ios64/c " c::*cc-flags*))
       (extra-args nil))
  #+(or mingw32 cygwin)
  (progn
