...
toolchain_target=$(basename ${ANDROID_NDK_ROOT}/toolchains/${toolchain_arch}-${toolchain_version})
toolchain_path="${ANDROID_NDK_ROOT}/toolchains/${toolchain_target}/prebuilt/${toolchain_dir}/bin/"
