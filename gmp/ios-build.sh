...
# ./configure --srcdir=/Users/strobolights/dev/mecl/ios64-bdwgc --prefix=/Users/strobolights/dev/mecl/local-install/iPhoneOS-${ARC2} --target=${ARC}-apple-darwin --host=${ARC}-apple-darwin --enable-gmpcompat --disable-shared 

./configure --srcdir=/Users/strobolights/dev/mecl/ios64-gmp --prefix=/Users/strobolights/dev/mecl/local-install/iPhoneOS-${ARC2} --target=${ARC}-apple-darwin --host=${ARC}-apple-darwin --enable-gmpcompat --disable-shared --enable-assembly=no
